...
Anti-AI-slop checklist (le Lead vérifie personnellement) :
□ Le projet n'utilise PAS de gradient violet/bleu générique
□ Le projet n'utilise PAS Inter/Roboto comme seule police
□ Le projet n'a PAS de grid 3 colonnes de cards identiques
□ Le projet a une identité visuelle reconnaissable
□ Un juge pourrait distinguer ce projet des 50 autres soumissions
